CLASS zcl_delete_zhp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_delete_zhp IMPLEMENTATION.
...
* SY-UNAME
    ...
    SELECT * FROM zhp_employeerel INTO TABLE @DATA(lt_data).
    IF sy-subrc = 0.
      DELETE zhp_employeerel FROM TABLE @lt_data.
      commit work.
    ENDIF.
